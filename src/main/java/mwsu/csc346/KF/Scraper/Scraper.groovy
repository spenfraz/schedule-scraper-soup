...
class Scraper {
    ...
    static def getSections(String department, String semester, PrintWriter writer) {

        println "Processing $department for semester $semester."
        ArrayList<Section> sections = new ArrayList<>();
        Section sec = null;

        //  def baseURL = "https://aps2.missouriwestern.edu/schedule/"
        //   Document doc = Jsoup.parse(new File(department + ".html"), "UTF-8", baseURL)
